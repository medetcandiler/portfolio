...
const HeroSection = () => {
  ...
  return (
    <section ref={heroRef} className={`container mx-auto flex h-screen-80 px-6 w-full justify-center items-center space-x-4 transition ease-in duration-700 ${isVisible ? " translate-y-0 opacity-100" : " -translate-y-5 opacity-0"}`}>
