  ...
  return (
    <section ref={heroRef} >
      <div className={`container mx-auto flex h-screen-80 px-6 w-full justify-center items-center space-x-4`}>
        <div className={`left w-full text-center flex flex-col space-y-3 md:space-y-6 md:w-3/5 md:text-start transition-all duration-300 ease-in ${isVisible ? 'opacity-1  md:translate-x-0' : 'opacity-0 md:-translate-x-5'}`}>
