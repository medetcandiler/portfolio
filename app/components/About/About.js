  ...
  return (
    <section ref={aboutRef} >
      <div className={` flex flex-col items-center space-y-6 px-6 md:flex-row md:space-y-0 md:space-x-10 `}>
        <div id="about" className={`left text-md flex flex-col text-center space-y-5  leading-relaxed md:text-lg md:w-2/3 md:text-start transition-all duration-700 ease-in-out ${isVisible ? 'opacity-1 translate-y-0 md:translate-x-0' : 'opacity-0 -translate-y-5 md:-translate-x-5 md:translate-y-0'} `}>
