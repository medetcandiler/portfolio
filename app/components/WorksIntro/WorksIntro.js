...
const WorksIntro = () => {
  ...
  return (
    <section id="work" ref={workRef} >
      <div className={`container mx-auto mt-[1px] flex flex-col justify-center leading-relaxed text-sm text-center pb-28 px-6 transition-all ease-in duration-700 ${isVisible ? "opacity-100 translaye-y-0" : "opacity-0 -translate-y-5"}  md:text-start md:text-lg`}>
