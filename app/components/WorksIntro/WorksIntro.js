...
const WorksIntro = () => {
  ...
  return (
    <section id="work" ref={workRef}>
      <div className={`container mx-auto mt-[1px] pt-12 flex flex-col justify-center leading-relaxed text-center pb-28 px-6 transition ease-in duration-500 ${isVisible ? "opacity-100 md:translaye-y-0" : "opacity-0 md:-translate-y-5"}  md:text-start md:text-lg`}>
