  ...
  return (
    <div id="let" ref={contactRef} >
      <div className={`relative py-28 flex flex-col space-y-12 justify-center md:h-screen md:flex-row md:space-y-0 md:space-x-12 md:items-center md:py-0`}>
        <div className={`flex justify-center items-center transition-all duration-300 ease-in ${isVisible ? 'opacity-1 translate-y-0 md:translate-x-0' : 'opacity-0 -translate-y-5 md:-translate-x-5 md:translate-y-0'}`}>
        ...
        <div className={`right flex justify-center text-center md:w-1/2 md:text-start transition-all duration-300 ease-in ${isVisible ? 'opacity-1 translate-y-0 md:translate-x-0' : 'opacity-0 -translate-y-5 md:translate-x-5 md:translate-y-0'}`}>
